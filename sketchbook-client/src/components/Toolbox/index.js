...
import { COLORS, CANVAS_TOOLS } from '@/constants'
...
const Toolbox = () => {
    ...
    const showStrokeToolOption = activeMenuItem === CANVAS_TOOLS.PENCIL
    const showBrushToolOption = activeMenuItem === CANVAS_TOOLS.PENCIL || activeMenuItem === CANVAS_TOOLS.ERASER
